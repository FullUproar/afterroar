...
- Name: tenant-isolation.spec.ts >> tenant isolation >> creating a customer in A does NOT appear in B
- Location: tests\tenant-isolation.spec.ts:184:7
        ...
        - generic [ref=e87]:
          - generic [ref=e88]:
            - generic [ref=e89]:
              ...
              - paragraph [ref=e91]: Updated 11:39 PM
          ...
          - generic [ref=e95]:
            - generic [ref=e97]:
              - generic [ref=e98]: 🚨
              - generic [ref=e99]:
                - heading "40 items running low" [level=3] [ref=e100]
                - paragraph [ref=e101]: Stitch - Rock Star (Enchanted) is most urgent — 1 left, selling 2.1/week. Order by Wednesday or you'll be out. 39 more also need attention.
          ...
          - link "View all 17 insights →" [ref=e133] [cursor=pointer]:
            - /url: /dashboard/cash-flow
