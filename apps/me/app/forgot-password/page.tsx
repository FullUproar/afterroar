          ...
          <PlayerCard maxWidth="26rem">
            ...
            <div style={{
              ...
              <p style={{ ...TYPE.body, fontSize: '0.92rem', color: 'var(--ink-soft)', lineHeight: 1.55, margin: 0 }}>
                If an account exists for <strong style={{ color: 'var(--cream)' }}>{email}</strong>, we sent a reset link there. The link expires in 1 hour.
              </p>
              <p style={{ ...TYPE.body, fontSize: '0.85rem', color: 'var(--ink-faint)', margin: 0, lineHeight: 1.5 }}>
                Didn&apos;t see it? Check your spam folder, or try requesting a new link.
              </p>
          ...
          <div style={{
            ...
            <div style={{ textAlign: 'center' }}>
              ...
              <p style={{ ...TYPE.body, fontSize: '0.9rem', color: 'var(--ink-soft)', margin: '0.75rem 0 0', lineHeight: 1.5 }}>
                Enter the email on your Passport. We&apos;ll send you a link to set a new password.
              </p>
            </div>
