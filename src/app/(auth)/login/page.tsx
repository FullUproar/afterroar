      ...
      <div className="w-full max-w-sm rounded-xl border border-zinc-800 bg-zinc-900/50 p-6">
        <form onSubmit={handleSubmit} className="space-y-4">
          {isSignUp && (
            <>
              <div>
                <label htmlFor="storeName" className="mb-1 block text-xs font-medium text-zinc-400">
                  Store name
                </label>
                <input
                  id="storeName"
              ...
              <div>
                <label htmlFor="staffName" className="mb-1 block text-xs font-medium text-zinc-400">
                  Your name
                </label>
                <input
                  id="staffName"
