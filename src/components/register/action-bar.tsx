    ...
    <div className="shrink-0 flex items-center gap-0.5 sm:gap-1 px-1 sm:px-2 h-11 sm:h-14 border-b border-card-border bg-card overflow-x-auto">
      <div className="flex items-center gap-1 shrink-0">
        ...
        <button
          ...
          className={`flex flex-col items-center justify-center w-10 sm:w-12 lg:w-14 h-10 sm:h-12 rounded-xl transition-colors ${
            activePanel === "search"
      ...
      <div className="flex items-center gap-1 shrink-0">
        {hasCart && (
          <button onClick={onPark} className="flex items-center gap-0.5 px-1.5 sm:px-2 h-8 sm:h-10 rounded-lg text-muted hover:text-foreground hover:bg-card-hover text-[10px] sm:text-xs transition-colors" style={{ minHeight: "auto" }} title="Park cart">
            {"\u23F8"} <span className="hidden sm:inline">Park</span>
          </button>
        )}
        {parkedCount > 0 && (
          <button onClick={onRecall} className="flex items-center gap-0.5 px-1.5 sm:px-2 h-8 sm:h-10 rounded-lg text-muted hover:text-foreground hover:bg-card-hover text-[10px] sm:text-xs transition-colors" style={{ minHeight: "auto" }} title="Recall parked cart">
            {"\u25B6"}
        ...
        {hasLastReceipt && (
          <button onClick={onShowLastReceipt} className="hidden sm:block px-2 h-8 sm:h-10 rounded-lg text-muted hover:text-foreground hover:bg-card-hover text-xs transition-colors" style={{ minHeight: "auto" }} title="Last receipt">
            {"\u{1F4C4}"}
          </button>
        )}
      </div>
